...
export default function Register() {
  ...
  return (
    <section className="min-h-screen flex justify-center text-white ">
      ...
      <div className="flex w-fit h-fit items-center justify-cente mt-4 px-4 py-8 sm:px-6 sm:py-16 lg:px-8 lg:py-8 relative  rounded-2xl overflow-hidden  border-neutral-900 border">
        <div className="xl:mx-auto w-md z-20">
          <h2 className="text-center text-2xl font-light leading-tight   mb-16">
          ...
          <form className="mt-8" method="POST" action="#">
            <div className="space-y-5">
              <div>
                <label className="text-extralight text-sm">Name</label>
                <div className="mt-2">
                  <input
                    required
          ...
          <div className="mt-8 flex justify-center items-center gap-2 text-neutral-600 font-extralight">
            ...
            <Link to={`/login`} className="text-neutral-400 underline">
              Login Here
            </Link>
          </div>
        </div>
